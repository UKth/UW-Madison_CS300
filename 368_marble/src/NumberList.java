...
public class NumberList {
	...
	/**
	 * Creates an ArrayList of size, populated with numbers from 1 to 10 generated
	 * using rnd.nextInt().
	 * 
	...
	/**
	 * The resulting list should not have the same number twice in a row. Checks and
